...
namespace EksiSozluk.Common.Infrastructure
{
    public static class QueueFactory
    {
        ...
        {
            var factory = new ConnectionFactory();
            factory.Uri = new(QueueConstants.RabbitMQHost);
            var connection = factory.CreateConnection();
            var channel = connection.CreateModel();
        ...
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, string exchangeName, string exchangeType = QueueConstants.DefaultExchangeType) // exchange'in olusturulmus olmasından emin olmak için yazıyoruz.
        {
