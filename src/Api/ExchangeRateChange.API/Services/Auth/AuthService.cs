using AutoMapper;
using Azure.Core;
using ExchangeRateChange.API.Exceptions;
using ExchangeRateChange.API.Extensions.JwtConf;
using Microsoft.AspNetCore.Identity;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using Microsoft.IdentityModel.Tokens;
using ExchangeRateChange.Common.Extensions;
...
namespace ExchangeRateChange.API.Services.Auth
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(UserManager<AppUser> userManager, IUnitOfWork uow, IMapper mapper, IHttpContextAccessor httpContextAccessor, SignInManager<AppUser> signInManager)
        {
